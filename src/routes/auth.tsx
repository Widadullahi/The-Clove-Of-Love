...
export const Route = createFileRoute("/auth")({
  ...
  head: () => ({
    meta: [
      { title: "Sign in or join — The Clove of Love" },
      { name: "description", content: "Join The Clove of Love — Africa's verified matrimonial platform for marriage-minded singles." },
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      if (mode === "signup") {
        ...
        if (data.session) {
          toast.success("Welcome to The Clove of Love.");
          router.invalidate();
          navigate({ to: "/onboarding" });
        } else {
